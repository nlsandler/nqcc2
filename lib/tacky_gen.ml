...
let convert_binop = function
  ...
  | Ast.Mod -> Tacky.Mod
  | Ast.BitshiftLeft -> Tacky.BitshiftLeft
  | Ast.BitshiftRight -> Tacky.BitshiftRight
  | Ast.BitwiseAnd -> Tacky.BitwiseAnd
  | Ast.BitwiseOr -> Tacky.BitwiseOr
  | Ast.BitwiseXor -> Tacky.BitwiseXor
