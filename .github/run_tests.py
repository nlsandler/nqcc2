...
parser.add_argument(
    "--no-extra-opts",
    action="store_true",
    help="Don't run extra credit tests or use --int-only option (used to test baseline reference implementation without extra credit features)",
)
